...
class EventPlannerViewTest {
    ...
    fun onStart_validInput_notDisplayInvalidDateMessage(dayOfMonth: Int) {
        // given
    ...
    fun onStart_dayOfMonthIsOutOfValidRange_displayInvalidDateMessage(dayOfMonth: Int) {
        // given
    ...
    fun onStart_nonNumberInput_displayInvalidDateMessage(input: String) {
        // given
